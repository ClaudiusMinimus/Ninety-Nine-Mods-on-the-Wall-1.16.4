...
Last README file update: Mon Mar 15 16:11:46 CET 2021
...
command.everlastingabilities
command.everlastingabilities.abilities
command.everlastingabilities.abilities.action
command.everlastingabilities.abilities.action.player
command.everlastingabilities.abilities.action.player.ability
command.everlastingabilities.abilities.action.player.ability.level
command.everlastingabilities.config
command.everlastingabilities.config.property
command.everlastingabilities.config.property.value
command.everlastingabilities.version
command.ex
command.ex.args
command.execute
...
command.fpdebug
command.fpdebug.no
command.fpdebug.ores
command.fpdebug.ores.scan
command.fpdebug.ores.stats
command.fpdebug.recipes
command.fpdebug.recipes.answer
command.fpdebug.recipes.answer.text
command.fpdebug.recipes.porting
command.fpdebug.recipes.skip
command.fpdebug.research
command.fpdebug.research.check
command.fpdebug.research.reload
command.fpdebug.structures
command.fpdebug.structures.convert
command.fpdebug.structures.dungeon
command.fpdebug.structures.dungeon.threaded
command.fpdebug.structures.load
command.fpdebug.structures.load.name
command.fpdebug.structures.load.name.rotation
command.fpdebug.structures.load.name.rotation.raw_structure
command.fpdebug.structures.scan
command.fpdebug.structures.scan.from
command.fpdebug.structures.scan.from.to
command.fpdebug.structures.scan.from.to.name
command.fpdebug.structures.select
command.fpdebug.structures.select.pos
command.fpdebug.yes
command.ftbchunks
...
command.futurepack
command.futurepack.research
command.futurepack.research.player
command.futurepack.research.player.reset
command.futurepack.research.player.unlock
command.futurepack.research.player.unlock.research
command.futurepack.research.player.unlock.research.single
command.gamemode
